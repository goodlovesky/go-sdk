...
// 文档参考 https://studygolang.com/articles/29654
...
// NewMist 初始化
func NewMist(_increase int64) *Mist {
	mist := &Mist{increase: _increase}
	return mist
}

// GenerateUID 生成全局唯一ID
func (c *Mist) GenerateUID() int64 {
	c.Lock()
	c.increase++
